...
CMD ["bash", "-lc", "mkdir -p /var/www/html/wp-content/uploads /var/www/html/wp-content/themes/maison-elan /var/www/html/wp-content/plugins/maison-elan-content; cp -rf /usr/src/wordpress/wp-content/themes/maison-elan/. /var/www/html/wp-content/themes/maison-elan/; cp -rf /usr/src/wordpress/wp-content/plugins/maison-elan-content/. /var/www/html/wp-content/plugins/maison-elan-content/; chown -R www-data:www-data /var/www/html/wp-content/uploads /var/www/html/wp-content/themes/maison-elan /var/www/html/wp-content/plugins/maison-elan-content; a2dismod mpm_event mpm_worker >/dev/null 2>&1 || true; rm -f /etc/apache2/mods-enabled/mpm_event.* /etc/apache2/mods-enabled/mpm_worker.*; a2enmod mpm_prefork >/dev/null 2>&1 || true; exec docker-entrypoint.sh apache2-foreground"]
