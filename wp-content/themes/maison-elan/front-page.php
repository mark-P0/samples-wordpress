...
$services = [
  ['Signature Facial', 'Deeply nourishing facials tailored to your skin’s unique needs.', 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?auto=format&fit=crop&w=900&q=85'],
  ['Skin Renewal', 'Advanced treatments to refine texture, tone and clarity.', 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?auto=format&fit=crop&w=900&q=85'],
  ['Brows & Lashes', 'Expert shaping, tinting and lifting for effortless beauty.', 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?auto=format&fit=crop&w=900&q=85'],
  ['Massage Ritual', 'Restorative massages to relax the body and calm the mind.', 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&w=900&q=85'],
];
$specialists = [
      ...
      <div class="elan-services">
        <?php foreach ($services as $service): ?>
          <article class="elan-card elan-service">
            ...
            <div class="elan-service__body"><h3 class="elan-service__title"><?php echo esc_html($service[0]); ?></h3><p class="elan-service__desc"><?php echo esc_html($service[1]); ?></p><a class="elan-text-link" href="#contact">Learn more →</a></div>
          </article>
        <?php endforeach; ?>
      </div>
    </div>
